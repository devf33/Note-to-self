...
public class DialogNewNote extends DialogFragment {
    ...
    Button btnCancel = (Button) dialogView.findViewById
            (R.id.btnCancel);

    Button btnOK = (Button) dialogView.findViewById
            (R.id.btnOK);
        ...
        btnOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Set its variables to match the users
                // entries on the form
        ...
        // All of the rest of the code goes here
    }
